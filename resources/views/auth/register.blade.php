    ...
    <div class="card-body">
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-6">
                    <input id="username" type="text" class="form-control text-white @error('username') is-invalid @enderror" name="username" value="{{ old('username') }}" required autocomplete="username" autofocus>
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-6">
                    <input id="full_name" type="text" class="form-control text-white @error('full_name') is-invalid @enderror" name="full_name" value="{{ old('full_name') }}" required autocomplete="full_name" autofocus>
